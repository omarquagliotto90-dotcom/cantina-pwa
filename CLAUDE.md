...
4. ~~Nuovi campi (finestra di beva, posizione in cantina, formato)~~ — **deciso 20/09/2026: sì, sono nel piano.** Quindi il contatore `wines.bottiglie` non basta e si passa al modello a riga-per-bottiglia (P6 di `PIANO_DATI.md`). Conseguenze: P4 decade, P5 (rating) si fa sulla riga-bottiglia e segue P6, e il soft delete di P1b conviene portarlo dentro P6 invece di farlo due volte
